#!/bin/bash
# =============================================
# VPS Auto Install Script - RG-AIO
...
# Ask for Domain for WebSocket TLS
...
[Service]
ExecStart=/usr/bin/nc -l -p 8880 -e /bin/login
Restart=always
